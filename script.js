...
function ChangeSearchEngine(engine) {
    ...
    const oldIcon = document.getElementsByClassName(
        "search-icon-options-selected"
    )[0];
...
function search(query) {
    ...
    setTimeout(() => {
        window.location.href =
            searchEngines[selectedEngine] + encodeURIComponent(query);
    }, 150);
}
